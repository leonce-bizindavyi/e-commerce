          ...
          <div className='w-full px-6 sm:w-1/2 xl:w-1/3'>
            <div className='flex items-center px-5 py-6 bg-white rounded-md shadow-sm'>
              ...
              <div className='mx-5'>
                ...
                <div className='text-gray-500'>Visa Card</div>
              </div>
            </div>
          </div>
          ...
          <div className='w-full px-6 mt-6 sm:w-1/2 xl:w-1/3 sm:mt-0'>
            <div className='flex items-center px-5 py-6 bg-white rounded-md shadow-sm'>
              ...
              <div className='mx-5'>
                ...
                <div className='text-gray-500'>PayPal</div>
              </div>
            </div>
          </div>
          ...
          <div className='w-full px-6 mt-6 sm:w-1/2 xl:w-1/3 xl:mt-0'>
            <div className='flex items-center px-5 py-6 bg-white rounded-md shadow-sm'>
              ...
              <div className='mx-5'>
                ...
                <div className='text-gray-500'>Lumicash</div>
              </div>
            </div>
          </div>
        </div>
          ...
          <div className='w-full px-6 sm:w-1/2 xl:w-1/3'>
            <div className='flex items-center px-5 py-6 bg-white rounded-md shadow-sm'>
              ...
              <div className='mx-5'>
                ...
                <div className='text-gray-500'>Ecocash</div>
              </div>
            </div>
          </div>
