...
export const Signup = () => {
  ...
  const validationSchema = Yup.object().shape({
    ...
    username: Yup.string().required("You must input a name !").min(4, "Name must contain at least 4 characters")
  })
        ...
        <div className="w-full px-8 md:px-32 lg:px-24">
          <Formik initialValues={initialValues} onSubmit={handleSignup} validationSchema={validationSchema}>
            <Form className="bg-white rounded-md shadow-2xl p-5">
              <h1 className="text-gray-800 font-bold text-2xl mb-1 capitalize text-center">Create new account</h1>
              <p className="text-sm font-normal text-indigo-600 mb-8 capitalize text-center">To get Started with us</p>
              ...
              <div className="mb-4 w-full flex justify-center">
                <button type="submit" className="block px-11 bg-indigo-600 mt-5 py-2 rounded-2xl hover:bg-indigo-700 hover:-translate-y-1 transition-all duration-500 text-white font-semibold mb-2">Signup</button>
              </div>
